...
private:
	...
	void convertToCollector(
			const PolyVox::Mesh<PolyVox::CubicVertex<PolyVox::Material8>> &polyvoxMesh);
	void convertToCollector(
			const PolyVox::Mesh<PolyVox::Vertex<PolyVox::Material8>> &polyvoxMesh);
	...
	void setupNodeFromMaterial(
			const PolyVox::Material8 &material, const v3pos_t &fallback_pos);
