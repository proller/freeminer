	...
	bool simple_singleplayer_mode)
{
	...
	*/
	...
	int update_draw_list_last_vrange = 0;
...
*/
		...
		*/
		...
		if (client.getEnv().getClientMap().m_drawlist_last || update_draw_list_timer >= 3 ||
				update_draw_list_last_cam_pos.getDistanceFrom(camera_position) > MAP_BLOCKSIZE*BS*1 ||
			...
			TimeTaker tt_draw("mainloop: updateDrawList");
#ifndef __ANDROID__
